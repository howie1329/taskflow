...
export function TodayBoardView({
  ...
  return (
    <div className="flex h-full w-full min-h-0 flex-col gap-3 overflow-y-auto lg:flex-row lg:overflow-hidden">
      ...
      <div className="flex min-w-[260px] min-h-[200px] flex-col overflow-hidden rounded-xl border border-border/50 bg-background/60 lg:min-h-0 lg:w-[32%] xl:w-[28%]">
        {/* Today header */}
        <div className="sticky top-0 z-10 flex shrink-0 items-center justify-between border-b border-border/50 bg-background/85 px-3 py-2 backdrop-blur supports-backdrop-filter:bg-background/75">
